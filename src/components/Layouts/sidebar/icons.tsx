...
export function Contact(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
      ...
      {...props}
    >
      <path d="M4 4.75C2.757 4.75 1.75 5.757 1.75 7v10c0 1.243 1.007 2.25 2.25 2.25h16c1.243 0 2.25-1.007 2.25-2.25V7c0-1.243-1.007-2.25-2.25-2.25H4zm0 1.5h16c.414 0 .75.336.75.75v.638l-8.44 5.273a.75.75 0 01-.82 0L3.25 7.638V7c0-.414.336-.75.75-.75zm16 11.5H4a.75.75 0 01-.75-.75V9.41l7.47 4.67a2.25 2.25 0 002.56 0l7.47-4.67V17c0 .414-.336.75-.75.75z" />
    </svg>
  );
}

export function EstimateProject(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
      ...
      {...props}
    >
      <path d="M9 2.75A2.25 2.25 0 006.75 5v14A2.25 2.25 0 009 21.25h6A2.25 2.25 0 0017.25 19V5A2.25 2.25 0 0015 2.75H9zm0 1.5h6c.414 0 .75.336.75.75v14a.75.75 0 01-.75.75H9a.75.75 0 01-.75-.75V5c0-.414.336-.75.75-.75z" />
      <path d="M9.75 8a.75.75 0 01.75-.75h3a.75.75 0 010 1.5h-3A.75.75 0 019.75 8zm0 3a.75.75 0 01.75-.75h3a.75.75 0 010 1.5h-3a.75.75 0 01-.75-.75zm0 3a.75.75 0 01.75-.75h3a.75.75 0 010 1.5h-3a.75.75 0 01-.75-.75z" />
    </svg>
  );
}

export function Careers(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
      ...
      {...props}
    >
      <path d="M12 2.75a4.25 4.25 0 110 8.5 4.25 4.25 0 010-8.5zm0 1.5a2.75 2.75 0 100 5.5 2.75 2.75 0 000-5.5z" />
      <path d="M4.75 18c0-3.038 3.013-5.25 7.25-5.25S19.25 14.962 19.25 18v1a.75.75 0 01-1.5 0v-1c0-2.043-2.24-3.75-5.75-3.75S6.25 15.957 6.25 18v1a.75.75 0 01-1.5 0v-1z" />
    </svg>
  );
}
